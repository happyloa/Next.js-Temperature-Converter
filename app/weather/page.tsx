        ...
        <main className="min-h-screen w-full bg-slate-50 dark:bg-[#0B0C15] text-slate-900 dark:text-slate-100 selection:bg-[#00CECB]/30 transition-colors duration-300">
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                {weatherError ? (
                    ...
                    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-3xl border border-slate-200 dark:border-transparent bg-white/50 dark:bg-transparent py-20">
